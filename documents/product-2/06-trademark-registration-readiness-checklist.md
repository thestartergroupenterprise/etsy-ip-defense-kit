...
**Brand Name to Register:** [YOUR BRAND NAME]

**Date Checklist Completed:** [TODAY'S DATE]
...
**Does your mark include any of the following?** (These require additional consideration)
[ ] A surname (last name)
[ ] Geographic terms (city, state, country names)
[ ] Purely ornamental elements (decorative patterns without brand identity function)
[ ] A living person's name or likeness
[ ] Government symbols, flags, or insignia
...
**If filing a design mark, confirm you have:**
[ ] A clean, high-resolution image of the logo (.JPG format, 5 inches x 5 inches recommended)
[ ] The image shows the mark as used in commerce (no backgrounds, no decorative borders)
...
**Identify your primary class(es):**

| Class # | Category | Your Products/Services | Filing? |
|---------|----------|----------------------|---------|
| 14 | Jewelry | [YOUR PRODUCTS] | [ ] Yes [ ] No |
| 18 | Leather goods, bags, wallets | | [ ] Yes [ ] No |
| 25 | Clothing, footwear, headwear | | [ ] Yes [ ] No |
| 26 | Lace, embroidery, trimmings | | [ ] Yes [ ] No |
| 28 | Toys, games, sporting goods | | [ ] Yes [ ] No |
| 35 | Retail store services (including online retail) | [YOUR STORE] | [ ] Yes [ ] No |
| 40 | Custom manufacturing services | | [ ] Yes [ ] No |
| 41 | Education, entertainment, digital content | | [ ] Yes [ ] No |
...
[ ] Screenshot of your Etsy shop page showing the brand name prominently displayed
[ ] Screenshot of your Amazon storefront or product listing showing the brand name
[ ] Screenshot of your own website's product page showing the brand name
[ ] Photograph of product tag, label, or packaging showing the brand name
[ ] Screenshot of an online marketplace receipt or order confirmation showing the brand name
...
**Legal name of applicant (exactly as it will appear on the registration):**
...
**Email address (USPTO will use this for correspondence):**
[EMAIL]
...
- If approved: publication for opposition (30-day window)
- If no opposition: registration in approximately 11 to 13 months from filing date
- If you filed on Intent to Use: you must file a Statement of Use within 6 months of Notice of Allowance (extensions available)
...
*This document is for organizational and evidentiary purposes. It does not constitute legal advice. Trademark law is complex and jurisdiction-specific. For USPTO filing guidance or complex trademark matters, consult a qualified trademark attorney.*
