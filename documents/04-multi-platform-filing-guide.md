...
**Step 2: Select your infringement type**
- For stolen photos → select **"Copyright"**
- For someone copying your brand name or logo → select **"Trademark"**
- For someone selling counterfeit goods branded as yours → select **"Counterfeit"**

*This guide covers Copyright (most common for Etsy sellers).*
...
| **Additional description** | "The listing at the URL above uses my original photographs without my authorization. The images are identical/substantially similar to my original photos. I have not granted this seller any license or permission to use my images." |
| **Good faith statement** | Check the box |
| **Accuracy statement** | Check the box |
...
**Step 6: Follow up if no response in 7 days**
Email: copyright@etsy.com
Subject: "Follow-up on DMCA Case #[YOUR CASE NUMBER]"
Body: "I submitted a copyright infringement report on [DATE] regarding [INFRINGING URL]. My case number is [#]. I have not received an update. Please advise on the status of this case."
...
Temu requires supporting documents. Prepare:
- Screenshot of your original listing (with URL visible in browser bar)
- Screenshot of the infringing Temu listing (with URL visible)
- If possible: a side-by-side comparison image showing both

Upload these files in the "Supporting Materials" field.
...
AliExpress requires a free account to file. You cannot submit a report without one. Create your account at https://ipp.alibabagroup.com/ before you need it, so it's ready when you find infringement.

**AliExpress (Alibaba Group) IP Protection Platform:** https://ipp.alibabagroup.com/
...
3. Complete account creation with your real name and contact information
4. Verify your email address

**Step 2: Create a new complaint**
1. Log in to your IPP account
2. Click "Create Complaint" or "File a Report"
3. Select **"Copyright"** as the rights type
...
Amazon has two separate IP reporting paths depending on whether you are a registered brand:

- **If you have Amazon Brand Registry** → use the Brand Registry reporting tool (faster)
- **If you do NOT have Brand Registry** → use the standard IP infringement report form
...
- Click **"I have a copyright issue"**
- Select **"Unauthorized use of photos, videos, or other copyright-protected content"**
...
| **Description of original work** | "Original product photography created by me on [DATE]. My original listing: [YOUR AMAZON OR ETSY LISTING URL]." |
| **Type of infringing content** | "Product listing images" |
| **ASIN(s) or URL(s) of infringing content** | [PASTE THE AMAZON LISTING ASIN or full URL] |
| **How is it infringing?** | "The product listing uses my original photographs without authorization. I have not licensed these images to the seller or to Amazon. The images are identical/substantially similar to my original copyrighted work." |
...
2. Go to: **Brands → Report a Violation**
3. Search for the infringing ASIN or paste the listing URL
4. Click "Report a violation" next to the listing
...
### Escalation Path (if platform doesn't act within 14 days)
