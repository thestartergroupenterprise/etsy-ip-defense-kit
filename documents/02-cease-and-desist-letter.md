...
Dear [INFRINGING SELLER'S NAME / "Shop Owner"],

I am writing to notify you that you are currently infringing my intellectual property rights and to demand that you immediately cease and desist this infringing activity.
...
Your shop, [THEIR SHOP NAME], is currently using my copyrighted work without authorization at the following location(s):

**Infringing listing #1:**
...
I hereby demand that you take ALL of the following actions **within 48 hours** of receiving this letter:

1. **Remove all infringing content immediately.** Take down the listing(s) identified above and delete all copies of my copyrighted material from your shop, website, and any other platforms.

2. **Provide written confirmation.** Reply to this message confirming that you have removed all infringing content and that you no longer possess copies of my copyrighted work.

3. **Cease all further use.** Do not use my copyrighted materials in any new listings, on any platforms, or in any marketing materials, now or in the future.
...
Nothing in this letter constitutes a waiver of any of my rights or remedies, all of which I expressly reserve.
...
**Via Etsy "Contact Seller" button:**
1. Go to their shop page
2. Click "Contact" or "Message Seller"
3. Copy and paste this letter into the message field
4. Send and screenshot the sent message immediately
5. Note the date and time in your records
...
**Platform reporting alongside C&D:**
- Send this letter AND file a platform DMCA notice (Document 1 of this kit) at the same time
- Reference in your DMCA filing: "I have also notified the seller directly via [Etsy messaging / email] on [DATE]"

---

## RECORD-KEEPING

Immediately after sending, log:

- Date sent: [DATE AND TIME]
- Method: [Etsy message / email / both]
- Screenshot saved: [YES / NO]
- Seller's response: [Note any reply received and the date]
- Deadline (48 hours): [DATE AND TIME]
- Follow-up action if no response: File DMCA notice on [DATE]
